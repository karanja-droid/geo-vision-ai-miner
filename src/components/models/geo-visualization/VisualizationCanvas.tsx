...
const VisualizationCanvas: React.FC<VisualizationCanvasProps> = ({
  ...
  // Effect to handle canvas dimensions
  useEffect(() => {
    ...
    const updateDimensions = () => {
      ...
      if (container) {
        ...
        // Set the canvas drawing buffer size to match display size
        canvas.width = width;
  ...
  }, [dataset, visualizationMode, rotation, zoom, dimensions]);
  ...
  const drawVisualization = (
    ...
    try {
      ...
      ctx.fillText("Error rendering visualization", width / 2, height / 2 - 10);
      ctx.fillText("Please try another dataset", width / 2, height / 2 + 20);
    }
  };
